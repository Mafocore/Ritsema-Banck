            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Card Body -->
                        <div class="card-body">
                            <h4 class="small font-weight-bold">Afbetaald<span class="float-right">25%</span>
                            </h4>
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="img/undraw_at_home_octe.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="img/undraw_quite_town_mg2q.svg" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card border p-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="img/undraw_small_town_rxs3.svg" alt="">
                                    </div>
                                </div>
                            </div>
